...
namespace PagedList.Mvc
{
    ...
    public static class HtmlHelper
    {
                                                 ...
                                                 GoToFormRenderOptions options)
        {
            ...
            AppendHtml(fieldset, TagBuilderToString(input, Microsoft.AspNetCore.Mvc.Rendering.TagRenderMode.SelfClosing));

            AppendHtml(fieldset, TagBuilderToString(submit, Microsoft.AspNetCore.Mvc.Rendering.TagRenderMode.SelfClosing));
